        ...
        <!--<div class="row">    -->
            ...
            <div class="col-md-2">
                ...
                <?php if(in_array($ts, $bookings)){ ?>
                    ...
                    <?php }  ?><button class="btn btn-success book" data-timeslot="<?php echo $ts; ?>"><?php echo $ts; ?></button>
            </div>
        <!--</div>-->
    </div>
    <?php } ?>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group pull-right">
                            <button name="submit" id ="book1" type="submit" class="btn btn-primary">Book</button>
                        </div>
                    </form>
                </div>
            </div>
