...
<html lang="en">
   ...
   <body>
      <div class="container">
	  <div class="imgcenter"><img src="image/bot_avatar.png" alt=""></div><br>
					 ...
					 <ul class="list-unstyled messages-list">
							...
							if(mysqli_num_rows($res)>0){
								...
								<li class="messages-me clearfix start_chat">
								   Welcome To Indian Football Hub <br> How can i Help You?
								</li>
								<?php
							}
							?>
			...
			if(txt){
				jQuery.ajax({
					...
					success:function(result){
						var html='<li class="messages-you clearfix"><span class="message-img"><img src="image/id_bot.png" class="avatar-sm rounded-circle"></span><div class="message-body clearfix"><div class="message-header"><strong class="messages-title">Chatbot</strong> <small class="time-messages text-muted"><span class="fas fa-time"></span> <span class="minutes">'+getCurrentTime()+'</span></small> </div><p class="messages-p">'+result+'</p></div></li>';
						jQuery('.messages-list').append(html);
