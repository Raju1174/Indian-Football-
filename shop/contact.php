...
require('top.php');					
?>
<div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0) url(images/bg/bg5.png) no-repeat scroll center center / cover ;">
                    ...
                    <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12">
                        ...
                        <div class="address">
                            ...
                            <div class="address__details">
                                ...
                                <p>Football House, Sector 19, Phase 1, </p>
                            </div>
                        </div>
                        <div class="address">
                            <div class="address__icon">
