...
$meta_title="Indian Football Shop";
$meta_desc="Indian Football Shop";
$meta_keyword="Indian Football Shop";
                    ...
                    <div class="row">
                        <div class="menumenu__container clearfix">
                            <div class="col-lg-2 col-md-2 col-sm-3 col-xs-5"> 
                                <div class="logo">
                                <a href="index.php"><img src="images/logo1.png" alt="logo images" height="50%" width="50%"></a>
                                </div>
                            </div>
