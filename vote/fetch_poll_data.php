...
$php_framework = array("mohunbagan", "bengaluru", "chennainyin", "odisha", "fcgoa", "hyderabad", "jamshedpur", "kerala", "mumbai", "eastbengal", "northeast");
    ...
    <div class="col-md-10">
     <div class="progress">
      <div class="progress-bar '.$progress_bar_class.'" role="progressbar" aria-valuenow="'.$percentage_vote.'" aria-valuemin="0" aria-valuemax="100" style="width:'.$percentage_vote.'%">
       '.$percentage_vote.' % Fans like <b>'.$row.'</b> Team
      </div>
     </div>
    </div>
   </div>
